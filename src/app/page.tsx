...
import Link from "next/link";
import { ArrowRight, Sparkles, Code, Zap, Menu, X } from "lucide-react";
import { Button } from "@/components/ui/button";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-zinc-950 to-black text-white flex flex-col">
      ...
      <nav className="w-full border-b border-zinc-800 bg-black/50 backdrop-blur-md fixed top-0 z-50">
          ...
          <div className="hidden md:flex gap-3">
            <Link href="/sign-in">
              <Button
                variant="outline"
                className="h-9 px-5 rounded-xl border border-purple-500/30 
                 bg-black/30 backdrop-blur-md text-purple-300 hover:text-white 
                 hover:bg-purple-600/20 hover:border-purple-500/60 shadow-lg shadow-purple-900/30 transition-all cursor-pointer"
              >
                Sign In
              </Button>
            </Link>
            <Link href="/sign-up">
              <Button
                className="h-9 px-5 rounded-xl bg-gradient-to-r from-purple-600 to-pink-500 
                 hover:from-purple-700 hover:to-pink-600 text-white font-medium shadow-lg shadow-purple-900/40 
                 flex items-center gap-1 transition-all cursor-pointer"
              >
                Get Started <ArrowRight className="w-4 h-4" />
              </Button>
        ...
        {/* Mobile Menu */}
        {menuOpen && (
          <div className="md:hidden px-4 pb-4 flex flex-col gap-3 text-zinc-300 text-sm bg-zinc-900/90 border-t border-purple-800/30 shadow-lg backdrop-blur-md">
            ...
            <div className="flex gap-3 mt-2">
              <Link href="/sign-in" className="flex-1">
                <Button
                  variant="outline"
                  className="w-full h-9 rounded-xl border border-purple-500/30 
                   bg-black/30 backdrop-blur-md text-purple-300 hover:text-white 
                   hover:bg-purple-600/20 hover:border-purple-500/60 shadow-lg shadow-purple-900/30 transition-all"
                >
                  Sign In
                </Button>
              </Link>
              <Link href="/sign-up" className="flex-1">
                <Button
                  className="w-full h-9 rounded-xl bg-gradient-to-r from-purple-600 to-pink-500 
                   hover:from-purple-700 hover:to-pink-600 text-white font-medium shadow-lg shadow-purple-900/40 
        ...
        <div className="w-full max-w-5xl mx-auto px-4 space-y-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/sign-up">
              <Button
                className="h-12 px-8 rounded-2xl bg-gradient-to-r from-purple-600 to-pink-500 
                 hover:from-purple-700 hover:to-pink-600 text-white text-lg font-semibold shadow-xl shadow-purple-900/40 
                 transition-all cursor-pointer"
              >
                Start for Free
              </Button>
            ...
            <Link href="/docs">
              <Button
                variant="outline"
                className="h-12 px-8 rounded-2xl border border-purple-500/30 
                 bg-black/30 backdrop-blur-lg text-purple-300 text-lg font-medium 
                 hover:bg-purple-600/20 hover:text-white hover:border-purple-500/60 
                 shadow-lg shadow-purple-900/30 transition-all cursor-pointer"
              >
                Read Docs
          ...
          {[
            {
              icon: <Sparkles className="text-blue-400 w-10 h-10" />,
              title: "Instant Code Generation",
              description: "Generate React, JavaScript, and backend code instantly with AI assistance.",
            },
            {
              icon: <Code className="text-purple-500 w-10 h-10" />,
              title: "Debug Smarter",
              description: "Explain errors, fix bugs, and optimize your code with AI-driven insights.",
            },
            {
              icon: <Zap className="text-green-400 w-10 h-10" />,
              title: "Boost Productivity",
              description: "Automate repetitive tasks so you can focus on building great products.",
            },
          ].map((feature, i) => (
            <div
              key={i}
