...
//           <div
//             key={i}
//             className="group bg-zinc-900/60 p-6 rounded-xl hover:bg-zinc-800/80 transition-all cursor-default border border-transparent hover:border-purple-500/50 hover:shadow-lg"
//           >
...
//             <ul className="mt-4 text-zinc-500 text-sm space-y-1 list-disc list-inside">
